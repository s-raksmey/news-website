...
export default async function ArticlePage({ params }: ArticlePageProps) {
  ...
  // Verify the article belongs to the correct category/subcategory
  ...
  const breadcrumbItems = [
    ...
    { title: subcategoryData?.title || subcategory, href: `/${category}/${subcategory}` },
    { title: article.title }
  ];
...
export async function generateStaticParams() {
  ...
  return mockArticles
    .filter(article => article.subcategory) // Only articles with subcategories
    .map((article) => ({
